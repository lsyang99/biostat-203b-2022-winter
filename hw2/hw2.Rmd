...
**Answer:**    
From the *elapsed* shown below we know that `fread` and `read_csv` runs much faster than `read.csv`, and `fread` runs the fastest. Data types differ depending on the function used. 
```{r}
